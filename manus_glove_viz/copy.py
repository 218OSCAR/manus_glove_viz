...
class ManusGloveVisualizer(Node):
    ...
    def publish_corrected_glove(self, msg: ManusGlove):
        ...
        for node in msg.raw_nodes:
            ...
            new_node = ManusRawNode()   # <-- REAL type
            ...
            new_node.pose.orientation.x = qx
            new_node.pose.orientation.y = qy
            new_node.pose.orientation.z = qz
            new_node.pose.orientation.w = qw
